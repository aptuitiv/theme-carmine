/* ===========================================================================
    ...
    inside the header (display: none), the browser's scroll-anchoring
    silently nudges scrollY to keep visual position stable. That nudge
    can flip scrollY back across the sticky threshold and produce a
    rapid is-sticky / hide / show loop.
...
const stickyHeader = {
    ...
    hide() {
        // Never move the header offscreen while keyboard focus is inside it (WCAG 2.4.11)
        if (this.isHidden || this.header.contains(document.activeElement)) return;
